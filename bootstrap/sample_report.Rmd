...
Different thresholds can be applied to remove samples depending on the declared sex. In this analysis, males are removed if F is below `r params$F_threshold_male` and females are removed if F is above `r params$F_threshold_female`.
